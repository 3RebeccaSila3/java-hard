public class ArraySlotAccess {
    public static void main( String[] args ) {
        ...
        //isplaying all the values in an array usually looks like this
        ...
        //Displaying them again, one at a time.
        System.out.println("Values: " + arr[0] + " " + arr[1] + " " + arr[2]);
        ...
        //I hope so. If not, read through this code agin more slowly
        System.out.print("values: ");
        for ( int q=0; q < arr.length; q++ ) {
